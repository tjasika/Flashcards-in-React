export const flashcards = [
    {
     ...
     {
        front: `What’s the difference between a pointer and a reference?`,
     ...
     {
        front: `What is the difference between BFS and DFS in terms of traversal?`,
        back: `BFS explores level by level (uses a queue), DFS explores depth-wise (uses a stack or recursion).`
    },
     {
        front: `Which algorithm finds the shortest path in a graph with non-negative weights?`,
